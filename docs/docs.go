...
var doc = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/system.Authority"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/example.Customer"
                        }
                    }
                ],
                "responses": {
        ...
        "/fileTransfer/breakpointContinue": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/example.FileTransfer"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/system.BaseMenu"
                        }
                    }
                ],
                "responses": {
        ...
        "/operations/createOperations": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建Operations",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/system.Operations"
                        }
                    }
                ],
                "responses": {
        ...
        "/operations/deleteOperationsByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.OperationsSearch"
                        }
                    }
                ],
                "responses": {
        ...
        "system.BaseMenu": {
            ...
            "properties": {
                ...
                "parameters": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/system.BaseMenuParameter"
                    }
                },
                "parentId": {
                    "description": "父菜单ID",
